...
GUILD_ID = 1512089939284590752

# ─── Role IDs ──────────────────────────────────────────────────────────────────
ROLE = {
    "middleman":    1512089939284590758,
    "head_mid":     1512089939284590759,
    "lead_mid":     1512089939305566420,
    "moderator":    1512089939305566422,
    "senior_mod":   1512089939305566424,
    "coordinator":  1512089939305566428,
    "administrator":1512089939318407339,
    "manager":      1512089939318407342,
    "co_founder":   1512089939318407341,
    "chief_exec":   1512089939347505283,
    "director":     1512089939347505283,
    "president":    1512089939347505284,
    "index_mm":     1512089939284590758,
    "ban_perms":    1512089939318407339,
}
...
# ─── Channel IDs ───────────────────────────────────────────────────────────────
CH = {
    "mm_setup":       1512089940085702665,
    "mm_ticket_cat":  1512089940547076309,
    "support_setup":  1512089940387954763,
    "support_cat":    1512089940387954767,
    "index_setup":    1512089940245217441,
    "index_cat":      1512089940245217445,
    "transcript_ch":  1512089940866105593,
    "ban_log":        1512089940866105593,
    "role_log":       1512089940866105593,
    "app_setup":      1512089939960135815,
    "app_cat":        1512089940085702661,
    "d7_setup":       1512089940245217448,
...
SETUP_ROLE   = 1512089939356024905  # only role that can use setup + tos/rules/faq commands
...
HITTER_ROLE_ID = 1512089939284590756  # mercy role
    ...
    async def accept(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        dm_embed.add_field(
            ...
            value=(
                ...
                "and create a ticket in <#1512089940085702665>. "
...
class D7Modal(discord.ui.Modal, title="Trading Matrix Ticket"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        d7_role = self.guild.get_role(1512089939356024905)
        ow = {
...
async def lock(ctx: commands.Context):
    """Give yourself the trader role. Usage: $lock"""
    trader_role = ctx.guild.get_role(1512089939284590756)
    if trader_role is None:
        return await ctx.send("❌ Trader role not found.", delete_after=5)

    if trader_role in ctx.author.roles:
        return await ctx.send("⚠️ You already have the trader role.", delete_after=5)

    await ctx.author.add_roles(trader_role, reason="Self-assigned via $lock")
    embed = discord.Embed(
        color=0x2b2d31,
        title="🔒 Trader Role Assigned",
        description=f"{ctx.author.mention} you have been given the trader role!"
    )
    embed.set_footer(text=FOOTER)
